...
--
-- Хост: 127.0.0.1
-- Время создания: Авг 16 2014 г., 22:39
...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  `in_published` enum('0','1') NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `catalog` (
  ...
  `summary` text NOT NULL,
  `content` text NOT NULL,
  `in_published` enum('0','1') NOT NULL DEFAULT '1',
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `view` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `catalog` (`id`, `slug`, `title`, `description`, `keywords`, `summary`, `content`, `in_published`, `created`, `view`, `parent_id`, `params1`, `params2`, `params3`, `params4`) VALUES
(2, 'qweert', 'Пункт 2', 'Пункт 4', 'Пункт 4', 'Пункт 4', 'Пункт 4', '1', '2014-08-13 15:26:13', 0, 0, '', '', '', ''),
(3, 'fgndgwer', 'Пункт 3', 'Пункт 3', 'Пункт 3', 'Пункт 3', 'Пункт 3', '1', '2014-08-13 15:27:10', 0, 4, '', '', '', ''),
(4, 'uilu', 'Пункт 4', 'Пункт 2', 'Пункт 2', 'Пункт 2', 'Пункт 2', '1', '2014-08-13 15:27:10', 0, 0, '', '', '', ''),
(5, 'tyjtj', 'Пункт 5', 'Пункт 1', 'Пункт 1', 'Пункт 1', 'Пункт 1', '1', '2014-08-13 15:28:19', 0, 4, '', '', '', '');
...
CREATE TABLE IF NOT EXISTS `items` (
  ...
  `content` text NOT NULL,
  `in_published` enum('0','1') NOT NULL DEFAULT '0',
  `in_new` enum('0','1') NOT NULL DEFAULT '0',
  `in_action` enum('0','1') NOT NULL DEFAULT '0',
...
INSERT INTO `items` (`id`, `title`, `description`, `keywords`, `summary`, `content`, `in_published`, `in_new`, `in_action`, `cat_id`, `view`, `created`, `price_current`, `price_old`, `params1`, `params2`, `params3`, `params4`) VALUES
(1, 'Товар 1', 'Товар 1', 'Товар 1', 'Товар 1', 'Товар 1', '1', '0', '0', 3, 0, '2014-08-16 15:23:47', 1000, 2000, '', '', '', ''),
(2, 'Товар 2', 'Товар 2', 'Товар 2', 'Товар 2', 'Товар 2', '1', '0', '0', 2, 0, '2014-08-16 15:23:47', 2000, 3000, '', '', '', ''),
(3, 'Товар 3', 'Товар 3', 'Товар 3', 'Товар 3', 'Товар 3', '1', '0', '0', 3, 0, '2014-08-16 15:40:06', 15000, 14000, '', '', '', ''),
(4, 'Товар 4', 'Товар 4', 'Товар 4', 'Товар 4', 'Товар 4', '1', '0', '0', 4, 0, '2014-08-16 15:40:06', 156000, 140000, '', '', '', ''),
(5, 'Пункт 5', 'Пункт 5', 'Пункт 5', 'Пункт 5', 'Пункт 5', '1', '0', '0', 2, 0, '2014-08-16 17:08:52', 14000, 15000, '', '', '', ''),
(7, 'Товар 7', 'Товар 7', 'Товар 7', 'Товар 7', 'Товар 7', '1', '0', '0', 4, 0, '2014-08-16 17:32:27', 100, 200, '', '', '', '');
...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `in_published` enum('0','1') NOT NULL DEFAULT '0',
  `in_menu` enum('0','1') NOT NULL DEFAULT '0',
  `view` int(11) NOT NULL DEFAULT '0',
  `params1` text NOT NULL,
  `params2` text NOT NULL,
  `params3` text NOT NULL,
...
('94a13f3b4d3cab4947938d5aebe0e065', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.143 Safari/537.36', 1408207490, 'a:1:{s:9:"user_data";a:7:{s:2:"id";s:1:"1";s:8:"username";s:5:"admin";s:8:"password";s:32:"202cb962ac59075b964b07152d234b70";s:5:"email";s:14:"admin@admin.ru";s:6:"status";s:1:"0";s:7:"comment";s:37:"Администратор сайта";s:4:"auth";b:1;}}');
